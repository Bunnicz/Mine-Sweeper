...
Built-in decorators:
@classmethod - define methods inside a class namespace
@staticmethod - define methods inside a class namespace
...
def register(func):
    """Register a function as a plug-in, similar to globals()"""
